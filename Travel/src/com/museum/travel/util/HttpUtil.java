...
public static final String BASE_URL = "http://tidedemo.com/museum/php/all.php";
...
public static String getRequest(String url , Context mContext){
	...
	Toast toast = Toast.makeText(mContext.getApplicationContext(), "无法获得网络数据，请设置网络", 100);
	toast.show();
	e.printStackTrace();
	return "xxxx";
